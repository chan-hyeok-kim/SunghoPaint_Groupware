...
CREATE TABLE `TRANSFER` (
	`TRANSFER_NO`				BIGINT			AUTO_INCREMENT NOT NULL,
	`EMPLOYEE_ID`				VARCHAR(255)	NOT NULL,
	`NAME`						VARCHAR(255)	NOT NULL,
	...
	`REG_MENU`					VARCHAR(255)	NULL,
	`MOD_ID`					VARCHAR(255)	NULL,
	`MOD_DATE`					DATETIME		NULL,
	`MOD_MENU`					VARCHAR(255)	NULL,
...
BEGIN
	...
	FROM
        CODE
	WHERE CODE = AS_CODE AND UP_CODE = AS_UP_CODE
	LIMIT 1;
...
INSERT INTO CODE VALUES('D006', 'D00', '대기', '', NOW(), '', '', NOW(), '');
...
SELECT *,
FN_CODE_NM(LEFT(POSITION_CD, 3), POSITION_CD) AS P_CODE_NAME,
FN_CODE_NM(LEFT(DEPARTMENT_CD, 3), DEPARTMENT_CD) AS D_CD_NAME 
	FROM HUMAN_RESOURCE;
...
VALUES
(
	NULL, '2023001', '테스트', NOW(),
	'U013', 'D002', 'U003', 'D002', 'D006',
	'2023001', NOW(), '', '2023001', NOW(), ''
);